...
This application supports 11 major LLM providers that can be configured directly from the UI:
...
- Support for 11 major LLM providers with vision capabilities
