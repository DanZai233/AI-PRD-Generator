...
/**
 * OpenRouter uses an OpenAI-compatible chat/completions API for many models.
 * This adapter follows the same request/response shape as `OpenAIAdapter`.
 */
export class OpenRouterAdapter implements BaseLLMAdapter {
